module hello-toolchain

go 1.25.11

require (
	github.com/pulumi/pulumi-azure-native-sdk/containerregistry/v3 v3.19.0
...
require (
	...
	github.com/pulumi/pulumi-azure-native-sdk/authorization/v3 v3.19.0 // indirect
